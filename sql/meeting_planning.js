exports.dao_set_meeting_planning = function(evt, mysql_conn, post){
	var sql = "INSERT INTO `meeting_planning` SET `idx_owner` = '1', `idx_owner_type` = 'user', `subject` = '"+post['meeting_subject']+"', `goal` = '"+post['meeting_goal']+"', `date` = '"+post['date']+"', `start_time` = '"+post['meeting_start_time']+"', `end_time` = '"+post['meeting_end_time']+"', `reg_time` = now()";
...
exports.dao_set_meeting_planning_users = function(evt, mysql_conn, post){
	var sql = "INSERT INTO `relation_user_meeting` SET `idx_user` = '"+post['user']+"', `idx_meeting` = '"+post['idx_meeting']+"'";
	var query = mysql_conn.query(sql, function(err, rows, fields) {
